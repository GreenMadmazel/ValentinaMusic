...
from ValentinaMusic.utils import AdminRightsCheck
from ValentinaMusic.utils.database import is_active_chat, is_nonadmin_chat
from ValentinaMusic.utils.decorators.language import languageCB
from ValentinaMusic.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await Valentina.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
